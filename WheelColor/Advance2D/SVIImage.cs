...
public class SVIImage : MonoBehaviour, IDragHandler, IPointerClickHandler
{
    [SerializeField]
    private Image pickerImage;
    private RawImage Svimage;
    private ColorPickButtonAdvance CC;
    private RectTransform rectTransform, pickerTransfrom;

    private void Awake()
    {
        Svimage = GetComponent<RawImage>();
        CC = FindObjectOfType<ColorPickButtonAdvance>();
